...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/blue-sun-25dd)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-sun-25dd
```

A live public deployment of this template is available at [https://blue-sun-25dd.templates.workers.dev](https://blue-sun-25dd.templates.workers.dev)
